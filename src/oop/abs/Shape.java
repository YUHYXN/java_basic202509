...
// 클래스에도 abstract 키워드를 붙일 수 있다.
public abstract class Shape {

    String color;

    public Shape(String color){
        this.color = color; // String color를 받아서 초기화
    }
    ...
    // 넓이||면적
    // 껍데기 메서드 추상 메서드가 되어야함
//    public double calculatorArea();
    public abstract double calculatorArea();

    // 둘레
    // 껍데기 메서드 추상 메서드가 되어야ㅐ함
//    public double calculatorPerimeter();
    public abstract double calculatorPerimeter();

    // 이렇게 해도 된다.
    public void displayInfo(){
        System.out.println("도형의 색상은 " + this.color + "입니다.");
    }
